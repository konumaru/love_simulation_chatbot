...
def talk(base_data: str, message: str) -> str:
    DEBUG_MODE = False
    ...
    * 会話のラストではストーリー展開AIは、今後のゲーム展開が盛り上がるように、多様性のある４つの選択肢を出しつつ、「自由に行動を入力してもよい」と出力してください。
    ...
    conversation = ConversationChain(
        verbose=DEBUG_MODE, memory=memory, prompt=prompt, llm=llm
    )
...
def main():
    ...
    first_message = talk(base_data, "それではゲームを開始してください")
    print(first_message)
